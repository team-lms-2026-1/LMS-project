...
import { ExtraCurricularOfferingDetailDto, ExtraCurricularOfferingListItemDto, PageMeta } from "../api/types";
import { fetchExtraCurricularDetail, fetchExtraCurricularOfferingList } from "../api/extraCurricularOfferingApi";
