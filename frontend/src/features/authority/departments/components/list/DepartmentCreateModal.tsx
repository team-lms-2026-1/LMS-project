...
import styles from "../../styles/DepartmentCreateModal.module.css";
...
export default function DepartmentCreateModal({ open, onClose, onSubmit }: Props) {
  ...
  return (
    <div className={styles.backdrop} role="dialog" aria-modal="true">
      <div className={styles.modal}>
        <div className={styles.title}>학과 등록</div>

        <div className={styles.formGrid}>
          <div className={styles.field}>
            <label className={styles.label}>학과명</label>
            <input
