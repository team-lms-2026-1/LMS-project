...
import type { FaqDetailDto } from "../api/types";
import { fetchFaqDetail } from "../api/faqsApi";
import { useI18n } from "@/i18n/useI18n";

type LoadState =
  | { loading: true; error: string | null; data: null }
  | { loading: false; error: string | null; data: FaqDetailDto | null };

function normalizeDetail(payload: any): FaqDetailDto {
...
export default function FaqDetailpageClient() {
  ...
  const t = useI18n("community.faqs.professor.detail");
    ...
    <div className={styles.page}>
      <div className={styles.card}>
        <div className={styles.breadcrumb}>
          <span className={styles.crumb} onClick={() => router.push("/professor/community/faqs")}>
            {t("title")}
          </span>
        ...
        {!state.loading && data && (
          <div className={styles.detailBox}>
            ...
            <div className={styles.footerRow}>
              <button className={styles.backBtn} onClick={() => router.push("/professor/community/faqs")}>
                {t("buttons.list")}
              </button>
            </div>
          </div>
