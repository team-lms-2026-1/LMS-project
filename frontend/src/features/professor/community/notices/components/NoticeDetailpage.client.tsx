...
export default function NoticeDetailpageClient() {
    ...
    const t = useI18n("community.notices.professor.detail");
        ...
        <div className={styles.page}>
            <div className={styles.card}>
                <div className={styles.breadcrumb}>
                    <span className={styles.crumb} onClick={() => router.push("/professor/community/notices")}>
                        {t("title")}
                    </span>
                ...
                {!state.loading && data && (
                    <div className={styles.detailBox}>
                        ...
                        <div className={styles.footerRow}>
                            <button className={styles.backBtn} onClick={() => router.push("/professor/community/notices")}>
                                {t("buttons.list")}
                            </button>
                        </div>
                    </div>
