...
import type { CurricularOfferingDetailDto } from "../../api/types";
import { useOfferingCompetencyMapping } from "../../hooks/useCurricularOfferingList";
import { ProfessorOfferingCompetencyRadarChart } from "./components/ProfessorOfferingCompetencyRadarChart";
import styles from "./ProfessorOfferingCompetenciesSection.module.css";
...
export function ProfessorOfferingCompetenciesSection({ offeringId, data }: Props) {
    ...
    <div className={styles.wrap}>
      ...
      <div className={styles.mainRow}>
        ...
        <div className={`${styles.section} ${styles.rightCol}`}>
          ...
          <div className={styles.body}>
            {!loading && !error && mappingData?.length ? (
              <ProfessorOfferingCompetencyRadarChart items={mappingData} />
            ) : null}
          </div>
        </div>
      </div>
