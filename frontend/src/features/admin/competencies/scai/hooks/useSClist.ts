...
import type { StudentCompetencyListItemDto, PageMeta } from "@/features/admin/competencies/scai/api/types";
import { fetchStudentCompetencyList } from "@/features/admin/competencies/scai/api/StudentCompetencyApi";
