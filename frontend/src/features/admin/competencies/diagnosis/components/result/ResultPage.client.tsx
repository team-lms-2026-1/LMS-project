...
import { useResultList } from "@/features/admin/competencies/diagnosis/hooks/useDignosisList";
import { recalculateCompetencySummary } from "@/features/admin/competencies/diagnosis/api/DiagnosisApi";
import type {
