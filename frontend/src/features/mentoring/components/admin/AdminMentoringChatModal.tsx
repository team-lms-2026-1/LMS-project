...
export function AdminMentoringChatModal({
    ...
    return (
        <Modal open={open} onClose={onClose} title="멘토링 채팅 내역 조회">
            <div style={{ padding: "0 20px 20px", display: "flex", flexDirection: "column", height: "60vh", minHeight: "400px" }}>
                <div style={{ marginBottom: 16, padding: "12px", background: "#f8f9fa", borderRadius: "8px" }}>
                    ...
                    <div style={{ display: "flex", gap: "16px", fontSize: "14px", color: "#555" }}>
                        <span><strong>멘토:</strong> {mentorName}</span>
                        <span><strong>멘티:</strong> {menteeName}</span>
                    </div>
                </div>
                ...
                <div style={{
                    ...
                    {loading ? (
                        ...
                        <div style={{ textAlign: "center", padding: "20px", color: "#888" }}>채팅 내역이 없습니다.</div>
                    ) : (
                                ...
                                <React.Fragment key={`${msg.type}-${msg.id}`}>
                                    {showDate && (
                                        <div style={{ textAlign: "center", margin: "16px 0 8px" }}>
                                            <span style={{ background: "rgba(0,0,0,0.1)", padding: "4px 12px", borderRadius: "12px", fontSize: "12px", color: "#555" }}>
                                                {dateStr}
                                            </span>
                                        </div>
                                    )}
                                    <div style={{ display: "flex", gap: "12px" }}>
                                        ...
                                        <div style={{ display: "flex", flexDirection: "column", maxWidth: "80%" }}>
                                            <span style={{ fontSize: "13px", fontWeight: "600", color: "#333", marginBottom: "4px" }}>
                                                {msg.senderName}
                                            </span>
                                            <div style={{
                                            ...
                                            <span style={{ fontSize: "11px", color: "#999", marginTop: "4px", marginLeft: "4px" }}>
