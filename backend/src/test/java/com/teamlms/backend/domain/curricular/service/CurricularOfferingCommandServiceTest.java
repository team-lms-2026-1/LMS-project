...
class CurricularOfferingCommandServiceTest {
        ...
        void create_Success() {
                ...
                offeringCommandService.create(
                                "OFF001", curricularId, semesterId, DayOfWeekType.MONDAY, 1, 30, "Room 101",
                                professorId);
        ...
        void patchMapping_Success() {
                ...
                OfferingCompetencyMappingBulkUpdateRequest req = new OfferingCompetencyMappingBulkUpdateRequest(
                                mappings);
        ...
        void patchScore_Success() {
                ...
                // when
                offeringCommandService.patchScore(offeringId, enrollmentId, 95, adminId);
