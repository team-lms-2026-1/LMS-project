...
class SurveyCommandServiceTest {
    ...
    void createAndPublishSurvey_Success_AllStudents() {
        ...
        SurveyQuestionDto qDto = new SurveyQuestionDto("질문1", 1, 1, 5, "매우나쁨", "매우좋음", true, SurveyQuestionType.RATING,
                null);
    ...
    void createAndPublishSurvey_Fail_InvalidDate() {
        ...
        SurveyCreateRequest request = new SurveyCreateRequest(
                ...
                List.of(new SurveyQuestionDto("Q", 1, 1, 5, "", "", true, SurveyQuestionType.RATING, null)),
                null);
    ...
    void patchSurvey_Success() {
        ...
        SurveyPatchRequest request = new SurveyPatchRequest(
                ...
                List.of(new SurveyQuestionDto("새 질문", 1, 1, 5, "", "", true, SurveyQuestionType.RATING, null)));
    ...
    void patchSurvey_Fail_HasResponses() {
        ...
        Long surveyId = 1L;
        SurveyPatchRequest request = new SurveyPatchRequest(
                SurveyType.SATISFACTION, "제목", "설정", LocalDateTime.now(), LocalDateTime.now().plusDays(1),
                List.of(new SurveyQuestionDto("Q", 1, 1, 5, "", "", true, SurveyQuestionType.RATING, null)));
