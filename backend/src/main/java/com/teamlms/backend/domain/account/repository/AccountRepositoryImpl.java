        ...
        return queryFactory
                .select(Projections.constructor(
                        ...
                        Projections.constructor(
                                ...
                                Expressions.nullExpression(AdminStudentDetailResponse.DeptSimple.class),
                                Expressions.nullExpression(AdminStudentDetailResponse.MajorSimple.class),
        ...
        return queryFactory
                .select(Projections.constructor(
                        ...
                        Projections.constructor(
                                ...
                                pp.email,
                                pp.phone,
                                Projections.constructor(AdminProfessorDetailResponse.DeptSimple.class, d.deptId, d.deptName)
                        )
                ))
                .from(a)
