...
public class QnaService {
        ...
        public ExternalQnaDetailResponse getQuestionDetail(Long questionId) {
                ...
                // 실명 조회
                String questionAuthorName = communityAccountRepository
                                .findRealName(question.getAuthor().getAccountId());

                ExternalAnswerResponse answerDto = null;
                if (question.getAnswer() != null) {
                        QnaAnswer ans = question.getAnswer();
                        String answerAuthorName = communityAccountRepository
                                        .findRealName(ans.getAuthor().getAccountId());
                        answerDto = ExternalAnswerResponse.builder()
                                        .answerId(ans.getId())
                                        .content(ans.getContent())
                                        // [수정] 실명 사용
                                        .authorName(answerAuthorName != null ? answerAuthorName
                                                        : ans.getAuthor().getLoginId())
                ...
                return ExternalQnaDetailResponse.builder()
                                ...
                                // [수정] 실명 사용
                                .authorName(questionAuthorName != null ? questionAuthorName
                                                : question.getAuthor().getLoginId())
