...
public enum ErrorCode {
        ...
        MAJOR_NOT_FOUND(HttpStatus.NOT_FOUND, "MAJOR_NOT_FOUND", "전공을 찾을 수 없습니다..", "specialty.notFound"),
        ...
        NOTICE_NOT_CATEGORY(HttpStatus.NOT_FOUND, "NOTICE_NOT_CATEGORY", "카테고리가 존재하지 않습니다.",
                        "notice.category.notFound"),
        ...
        ENROLLMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "ENROLLMENT_NOT_FOUND", "수강 신청 내역이 존재하지 않습니다.",
                        "enrollment.notFound"),
        ...
        OFFERING_CAPACITY_FULL(HttpStatus.CONFLICT, "OFFERING_CAPACITY_FULL", "수강 정원이 초과되었습니다.",
        ...
        ENROLLMENT_OFFERING_MISMATCH(HttpStatus.CONFLICT, "ENROLLMENT_OFFERING_MISMATCH",
                        "해당 수강정보는 요청한 교과 운영에 속하지 않습니다.", "enrollment.offering.mismatch"),
        ...
        INVALID_EXTRA_CURRICULAR_OFFERING_STATUS_TRANSITION(HttpStatus.CONFLICT,
                        "INVALID_EXTRA_CURRICULAR_OFFERING_STATUS_TRANSITION",
                        "비교과 운영 상태 전이가 올바르지 않습니다.", "extra.curricular.offering.status.invalid.transition"),

        EXTRA_CURRICULAR_OFFERING_STATUS_LOCKED(HttpStatus.CONFLICT, "EXTRA_CURRICULAR_OFFERING_STATUS_LOCKED",
                        "이미 완료된 비교과 운영은 상태를 변경할 수 없습니다.", "extra.curricular.offering.status.locked"),

        EXTRA_CURRICULAR_OFFERING_NOT_COMPLETABLE(HttpStatus.CONFLICT, "EXTRA_CURRICULAR_OFFERING_NOT_COMPLETABLE",
                        "비교과 운영을 완료 처리할 수 없습니다.", "extra.curricular.offering.notCompletable"),

        EXTRA_CURRICULAR_SESSION_NOT_EDITABLE(HttpStatus.CONFLICT, "EXTRA_CURRICULAR_SESSION_NOT_EDITABLE",
                        "OPEN 상태에서만 비교과 회차를 수정/취소할 수 있습니다.", "extra.curricular.session.notEditable"),

        EXTRA_APPLICATION_ALREADY_EXISTS(HttpStatus.CONFLICT, "EXTRA_APPLICATION_ALREADY_EXISTS",
                        "이미 비교과 신청이 완료되었습니다.", "extra.application.already.exists"),

        EXTRA_APPLICATION_STATUS_CONFLICT(HttpStatus.CONFLICT, "EXTRA_APPLICATION_STATUS_CONFLICT",
                        "현재 상태에서는 비교과 신청을 처리할 수 없습니다.", "extra.application.status.conflict"),

        // =========================
        // Domain: Mentoring
        // =========================
        MENTORING_RECRUITMENT_NOT_FOUND(HttpStatus.NOT_FOUND, "MENTORING_RECRUITMENT_NOT_FOUND",
                        "멘토링 모집 공고를 찾을 수 없습니다.",
                        "mentoring.recruitment.notFound"),
        MENTORING_APPLICATION_NOT_FOUND(HttpStatus.NOT_FOUND, "MENTORING_APPLICATION_NOT_FOUND",
        ...
        MENTORING_NOT_PARTICIPANT(HttpStatus.FORBIDDEN, "MENTORING_NOT_PARTICIPANT", "해당 멘토링의 참여자가 아닙니다.",
                        "mentoring.notParticipant"),
        MENTORING_ALREADY_MATCHED(HttpStatus.CONFLICT, "MENTORING_ALREADY_MATCHED", "이미 매칭된 신청자입니다.",
                        "mentoring.alreadyMatched"),
        ...
        INVALID_DATE_RANGE(HttpStatus.BAD_REQUEST, "INVALID_DATE_RANGE", "시작일이 종료일보다 빠를 수 없습니다.",
                        "diagnosis.date.invalid"),
        ...
        LOG_EXPORT_FILTER_REQUIRED(HttpStatus.BAD_REQUEST, "LOG_EXPORT_FILTER_REQUIRED", "검색 조건(필터)은 필수입니다.",
                        "log.export.filterRequired"),
        LOG_EXPORT_PERIOD_REQUIRED(HttpStatus.BAD_REQUEST, "LOG_EXPORT_PERIOD_REQUIRED",
                        "대량 다운로드 방지를 위해 기간(시작일/종료일) 선택은 필수입니다.", "log.export.periodRequired"),
        LOG_RESOURCE_NOT_SUPPORTED(HttpStatus.BAD_REQUEST, "LOG_RESOURCE_NOT_SUPPORTED", "지원하지 않는 로그 유형입니다.",
                        "log.resource.notSupported"),
        LOG_DATE_RANGE_INVALID(HttpStatus.BAD_REQUEST, "LOG_DATE_RANGE_INVALID", "시작일이 종료일보다 빠를 수 없습니다.",
                        "log.dateRange.invalid"),
        ...
        STUDY_RENTAL_USER_NOT_FOUND(HttpStatus.NOT_FOUND, "STUDY_RENTAL_USER_NOT_FOUND", "사용자를 찾지 못했습니다.",
                        "user.notFound"),
        STUDY_RENTAL_NOT_EN_TIME(HttpStatus.CONFLICT, "STUDY_RENTAL_NOT_EN_TIME", "종료 시간이 시작 시간보다 빠를 수 없습니다.",
                        "study.rental.not.en.time"),
